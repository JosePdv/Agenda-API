                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('eventos.update') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="responsavel" type="text"
                                        ...
                                        name="responsavel" value="{{ $evento->responsavel }}" required
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="nome" type="text"
                                        ...
                                        value="{{ $evento->nome }}" required autocomplete="nome" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="local" type="text"
                                        ...
                                        value="{{ $evento->local }}" required autocomplete="local" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-2">
                                    <a class="btn btn-info" href="{{ url('/storage/'.$evento->banner) }}"
                                        target="_blank"><i class='bx bxs-file-image'></i></a>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <textarea name="descricao" class="form-control @error('descricao') is-invalid @enderror" rows="5" required autocomplete="descricao" autofocus class="">{{ $evento->descricao }}</textarea> 
                                    @error('descricao')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="url" type="text" placeholder="Opcional, caso o evento seja uma LIVE"
                                        ...
                                        value="{{ $evento->url }}" autocomplete="url" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="mapa" type="text" placeholder="Opcional, caso o evento seja uma LIVE"
                                        ...
                                        value="{{ $evento->mapa }}" autocomplete="mapa" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="data" type="datetime-local" class="@error('data') is-invalid @enderror"
                                        name="data" value="{{ date('Y-m-d\TH:i:s', strtotime($evento->data)) }}"
                                        required autocomplete="data" autofocus>
                            ...
                            <div class="form-group row mb-0">
                                <div class="col-md-6 offset-md-4">
                                    <button type="submit" class="btn btn-primary" name="id" value="{{ $evento->id }}">
                                        {{ __('Cadastrar') }}
                                    </button>
                                </div>
                            </div>
